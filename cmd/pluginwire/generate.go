...
const generatedGoHeader = "// SPDX-License-Identifier: Elastic-2.0\n\n" +
	"// Code generated by pluginwire. DO NOT EDIT.\n\n"

const generatedTSHeader = "// SPDX-License-Identifier: AGPL-3.0-or-later\n\n" +
	"// Code generated by pluginwire. DO NOT EDIT.\n\n"
...
func generateGo(manifests []manifest) []byte {
	...
	b.WriteString(generatedGoHeader)
...
func generateTS(manifests []manifest) []byte {
	...
	var b strings.Builder
	b.WriteString(generatedTSHeader)
...
// run loads the plugin manifests under root and writes the generated Go and TypeScript wiring files.
